# kg-policejob
Police Job for KG-Core Framework :police_officer:
...
- [kg-bossmenu](https://github.com/kgcore-framework/kg-bossmenu)  (Deprecated) - For the boss menu
- [kg-management](https://github.com/kgcore-framework/kg-management) (Replaces kg-bossmenu) - For the boss/gang menu
- [kg-garages](https://github.com/kgcore-framework/kg-garages) - For the vehicle spawner
- [kg-clothing](https://github.com/kgcore-framework/kg-clothing) - For the locker room
- [kg-phone](https://github.com/kgcore-framework/kg-phone) - For the MEOS app and notifications etc.
- [kg-log](https://github.com/kgcore-framework/kg-logs) - (Deprecated) - For logging certain events
- [kg-smallresources](https://github.com/kgcore-framework/kg-smallresources) (Replaces kg-log) - kg-log was added to kg-smallresources
- [kg-menu](https://github.com/kgcore-framework/kg-menu) - For the vehicle menus
- [kg-input](https://github.com/kgcore-framework/kg-input) - For accessing evidence stashes
